<?php
$page_title = 'Контрактое производство';
$header_style = 'bg-grey';
 include_once ('header-page.php');?>
 <div class="container-produtions">
  <?php include_once ('./template-parts/productions.php');?>
  </div>
  <div class="container contracts">
  <h3 class="section-contracts">SEO Заголовок</h3>
          ...
          <a href="#" class="button-more">
            <svg class="contracts-svg" width="17" height="17">
                <use href="img/sprite.svg#read-more"></use>
              </svg>
              Читать больше</a>
</div>
