  ...
  <header class="header header-image">
    ...
    <div class="container but">
      <div class="swiper swiper-features ">
        ...
        <ul class="swiper-wrapper header-feauters">
          <!-- Slides -->
          <li class="swiper-slide header-feauters-item"> <svg class="logo-svg1">
              <use href="img/sprite.svg#Vector"></use>
            </svg>
            <p class="header-feauters-text">Непрерывная работа c 2017 года</p>
          </li>
          <li class="swiper-slide header-feauters-item"><svg class="logo-svg2">
              <use href="img/sprite.svg#Vector-1"></use>
            </svg>
            <p class="header-feauters-text">Вся продукция сертифицирована</p>
          </li>
          <li class="swiper-slide header-feauters-item"><svg class="logo-svg3">
              <use href="img/sprite.svg#Vector-2"></use>
            </svg>
            <p class="header-feauters-text">Контроль качества на всех этапах</p>
          </li>
          <li class="swiper-slide header-feauters-item"><svg class="logo-svg4">
              <use href="img/sprite.svg#Vector-3"></use>
            </svg>
            <p class="header-feauters-text fourth">Возможны поставки по всей России</p>
          </li>
          <li class="swiper-slide header-feauters-item"><svg class="logo-svg5">
              <use href="img/sprite.svg#Vector-4"></use>
            </svg>
            <p class="header-feauters-text fifth">Оперативное производство</p>
          </li>
        </ul>
  ...
  <section class="section section-light">
    <div class="container">
      <div class="work-container">
        ...
        <h2 class="section-title second">Схема работы</h2>
        <div class="swiper swiper-work">
          <!-- Additional required wrapper -->
          <ol class="swiper-wrapper steps second">
            <!-- Slides -->
        ...
        <div class="cards">
          ...
          <a href="#" class="card">
            <div class="card-content">
              ...
              <p class="card-text">А также стремящиеся вытеснить<br>традиционное производство, <br>нанотехнологии
                функционально
    ...
    <div class="container">
      <div class="founder-wrapper">
        <div class="founder-content">
          ...
          <a href="#" class="button-link mission-off">Подробнее о компании</a>
          <a href="#" class="button-link mission-on">О нашей миссии</a>
        </div>
      </div>
    </div>
    ...
    <div class="container">
      ...
      <div class="clients-wrapper">
        <div class="clients-content">
          <h2 class="section-title section-clients">Производим аэрозольную продукцию для разных сфер</h2>
          <ul class="clients-list">
            <li class="clients-list-item">
              <svg width="30" height="30" class="clients-list-item-svg">
                <use href="img/sprite.svg#him"></use>
              </svg>
              Химические производства
            </li>
            <li class="clients-list-item"><svg width="30" height="30" class="clients-list-item-svg">
        ...
        <div class="clients-logo-list">
          <a href="#" class="clients-logo-item"><img src="img/client.png" alt="" class="clients-logo-light">
          </a>
          <a href="#" class="clients-logo-item"><img src="img/client.png" alt="" class="clients-logo-light"></a>
          <a href="#" class="clients-logo-item"><img src="img/client.png" alt="" class="clients-logo-light"></a>
          <a href="#" class="clients-logo-item"><img src="img/client.png" alt="" class="clients-logo-light"></a>
          <a href="#" class="clients-logo-item"><img src="img/client.png" alt="" class="clients-logo-light"></a>
          <a href="#" class="clients-logo-item"><img src="img/client.png" alt="" class="clients-logo-light"></a>
      ...
      <div class="swiper swiper-blog">
        ...
        <div class="swiper-wrapper wrapper-blog">
          ...
          <a href="#" class="swiper-slide blog-card">
            <img src="img/blog/Blog.png" alt="" class="blog-card-img">
          ...
          <a href="#" class="swiper-slide blog-card">
            <img src="img/blog/Blog2.png" alt="" class="blog-card-img">
