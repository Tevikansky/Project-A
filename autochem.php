  ...
  <div class="container autochem-container prod-chem">
      <div class="autochem-wrapper">
        <div class="autochem-content">
          ...
          <p class="founder-text auto-text ">
...
<picture class="autochem-photo">
  ...
  <div class="container kind-autochem-container">
  <div class="autochem-content">
          <div class="seporator second"></div>
          <h2 class="section-title section-founder">Виды автохимии</h2>
          <p class="kind-autochem-text">
          ...
          <ul class="kind-autochem-list">
            <li class="kind-autochem-list-item">
              <svg width="16" height="3" class="about-list-item-svg">
                <use href="img/sprite.svg#hyphen"></use>
              </svg>
              Антискотч
            </li>
            <li class="kind-autochem-list-item">
